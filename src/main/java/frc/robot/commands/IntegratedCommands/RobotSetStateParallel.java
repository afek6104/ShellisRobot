...
public class RobotSetStateParallel extends ParallelCommandGroup {
  ...
  public RobotSetStateParallel(Elevator elevator, ElevatorState stateElevator, Arm arm, ArmState stateArm, Intake intake, double power) {
